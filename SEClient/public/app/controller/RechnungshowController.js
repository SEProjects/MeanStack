...
app.controller("RechnungshowController", function($scope,$http,$location,$routeParams,global){
    ...
    if(typeof list['Session'] == 'undefined')
    {
        ...
        $scope.s = true;
        $http.get(global.url + "/rechnung/" + list['Session'] + "/" + id).success(function (response) {
